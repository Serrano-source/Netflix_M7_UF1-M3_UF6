    ...
    <main id="mainContainer" class="p-b-40">
        ...
        <header class="d-flex space-between flex-center flex-middle">
            ...
            <div class="dropdown notification">
                ...
                <div class="dropdown">
                    <img src="../img/icons/user-image-green.png" alt="user profile icon" class="user-icon"> <span
...
<?php endif; ?>
  ...
  if (isset($_SESSION['user_id'])) {
    $records = $conn->prepare('SELECT id, nombre, email FROM usuarios WHERE id = :id');
