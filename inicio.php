                ...
                <section id="browse-dashboard" class=" d-flex direction-column flex-start middle-align">
                    ...
                    <div class="container text-container" style="z-index: 5;">
                        <div class="contentlogo">
                            <img src="img/tv-show/poster/never-have-ever-logo.webp" alt="content logo"
                                class="show-logo" />
                        </div>
            ...
            <div class="black-background">
                    ...
                    <div class="mylist-container d-flex flex-start flex-middle flex-no-wrap owl-carousel">
                        <div class="video">
                            <video class="mylist-img p-r-10 p-t-10 video-item"
                                poster="img/tv-show/poster/never-have-ever-short poster.jpg">
                                <source
                        ...
                        <div class="video">
                            <video class="mylist-img p-r-10 p-t-10 video-item"
                                poster="img/movies/we-are-the-milers-poster-little.webp">
                                <source
                ...
                <section id="continue-watching" class="container p-t-40">
                    ...
                    <div class="continue-watching-container d-flex flex-start flex-middle flex-no-wrap owl-carousel">
                                ...
                                <div class="video">
                                    <video class="mylist-img p-r-10 p-t-10 video-item"
                                        poster="img/movies/horrible-bosses-middle-poster.webp">
                                        <source
                                            src="img/tv-show/videos/Never Have I Ever - Official Trailer - Netflix_2.mp4"
                                            type="video/mp4">
                                            Su navegador no soporta la etiqueta de vídeo.
                                ...
                                <div class="video">
                                    <video class="mylist-img p-r-10 p-t-10 video-item"
                                        poster="img/movies/kabir-singh-poster.webp">
                                        <source
                                            src="img/tv-show/videos/Never Have I Ever - Official Trailer - Netflix_2.mp4"
                                            type="video/mp4">
                                            Su navegador no soporta la etiqueta de vídeo.
                ...
                <section id="romantic" class="container p-t-40">
                    ...
                    <div class="romantic-container d-flex flex-start flex-middle flex-no-wrap owl-carousel">
                        <a href="#">
                            <img src="img/movies/horrible-bosses-middle-poster.webp" alt=""
                                class="mylist-img p-r-10 p-t-10 image-size item"></a>
                        <a href="#">
                            <img src="img/movies/kabir-singh-poster.webp" alt=""
                                class="mylist-img p-r-10 p-t-10 image-size item"></a>
                        <a href="#">
                            <img src="img/movies/extraction-poster.jpg" alt=""
                                class="mylist-img p-r-10 p-t-10 image-size item"></a>
                        <a href="#">
                            <img src="img/tv-show/poster/never-have-ever-short poster.jpg" alt=""
                                class="mylist-img p-r-10 p-t-10 image-size item"></a>
                        <a href="#">
                            <img src="img/movies/we-are-the-milers-poster-little.webp" alt=""
                                class="mylist-img p-r-10 p-t-10 image-size item"></a>
                ...
                <section class="big-section d-flex flex-start container">
                    ...
                    <div class="right-side">
                        <div class="contentlogo">
                            <img src="img/tv-show/poster/sex-education-logo.webp" alt="content logo"
                                class="show-logo" />
                        </div>
